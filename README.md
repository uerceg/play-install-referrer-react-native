...
You can find example app using **react-native-play-install-referrer** plugin inside [**example-app-js**](./example-app-js) folder of this repository. In case you want to run the app (with re-adding plugin), you can run this command **inside app folder**:
